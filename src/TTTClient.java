 ...
 * It acts as a client which makes a connection to a TTTServer program.
...
class TTTClient {
     ...
     */
    private static final String DEFAULT_PORT = "1728";
    ...
    public static void main(String[] args) {
        ...
        Socket server;      // For communication with the server.
        ...
        try {
            ...
            server = new TTTSocket(computer,port);
